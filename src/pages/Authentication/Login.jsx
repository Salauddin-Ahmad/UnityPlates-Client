...
//           style={{
//             backgroundImage: `url('https://i.postimg.cc/brjH0mYF/Screenshot-2024-h05-10-093730.png')`,
//           }}
//         ></div>

//         <div className="w-full px-6 py-8 md:px-8 lg:w-1/2 bg-teal-200">

//           <p className="mt-3 text-xl text-center text-gray-600 ">
//             Welcome To UnityPlates!
//           </p>
...
const Login = () => {
  ...
  // makes the login page gone when google login popup or email login
  // is in action.  Otherwise good function to prevent if id already logged in
